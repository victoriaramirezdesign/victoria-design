...
- [ ] Confirmar los 4 servicios y sus nombres
- [ ] Ajustar descripciones y lista de entregables
- [ ] Precios de referencia (si se quieren mostrar)

## 4. Proyectos / portafolio (`src/content/projects.ts`)
Por cada proyecto real:
- [ ] Nombre del cliente y rubro
- [ ] Ano
- [ ] Categoria (Marca / Sitio / E-commerce / etc.)
- [ ] Resumen (1-2 lineas)
- [ ] Servicios que se hicieron
- [ ] Imagenes (portada + internas) -> `public/trabajos/<slug>/`
- [ ] Resultados con numeros (opcional pero recomendado)
- [ ] Caso de estudio: reto, proceso, resultado

## 5. Proceso (`src/content/process.ts`)
